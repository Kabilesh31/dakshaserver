...
// check-out
router.post("/check-out",protectAuth.protectAny, attendanceController.checkOut);

// get all attendance
router.get("/",protectAuth.protectAny, attendanceController.getAllAttendance);

// get attendance by staff
router.get("/staff/:staffId",protectAuth.protectAny, attendanceController.getAttendanceByStaff);
