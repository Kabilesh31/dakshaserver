...
router.put("/focus/:id", protectController.protectAny, productController.assignFocusProduct);
router.put("/unfocus/:id", protectController.protectAny, productController.unassignFocusProduct);
